...
export const trDialogOverlayClass =
...
@Directive({
  selector: '[trDialogOverlay],brn-dialog-overlay[hlm]',
  standalone: true,
})
export class TrDialogOverlayDirective {
  ...
  protected readonly _computedClass = computed(() =>
    hlm(trDialogOverlayClass, this.userClass())
  );
