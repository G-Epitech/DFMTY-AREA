...
@Component({
  ...
  selector: 'tr-sheet-content',
  standalone: true,
  imports: [TrSheetCloseDirective, BrnSheetCloseDirective, TrIconComponent],
  ...
  template: `
    ...
    <button brnSheetClose hlm>
      ...
      <tr-icon class="flex h-4 w-4" size="100%" name="heroXMark" />
    </button>
  `,
})
export class TrSheetContentComponent {
