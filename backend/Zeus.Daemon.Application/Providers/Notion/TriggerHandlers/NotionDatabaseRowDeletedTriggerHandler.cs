...
[TriggerHandler("Notion.DatabaseRowDeleted")]
public class NotionDatabaseRowDeletedTriggerHandler
{
    ...
    public NotionDatabaseRowDeletedTriggerHandler(IAutomationsLauncher automationsLauncher,
        ILogger<NotionDatabaseRowDeletedTriggerHandler> logger,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var success = await _pollingService.RegisterRemovePageDetected(automationId, accessToken,
            OnPageRemoved,
            cancellationToken);
    ...
    {
        _pollingService.UnregisterRemovePageDetected(automationId);
        _parentIds.Remove(automationId);

        return Task.FromResult(true);
    }

    private Task OnPageRemoved(AutomationId automationId, NotionPage notionPage,
