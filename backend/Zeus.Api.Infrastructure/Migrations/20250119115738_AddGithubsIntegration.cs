...
{
    /// <inheritdoc />
    public partial class AddGithubsIntegration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:IntegrationType", "discord,github,gmail,league_of_legends,notion,open_ai")
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .OldAnnotation("Npgsql:Enum:AutomationActionParameterType", "raw,var")
                .OldAnnotation("Npgsql:Enum:IntegrationTokenUsage", "access,refresh")
                .OldAnnotation("Npgsql:Enum:IntegrationType", "discord,github,gmail,league_of_legends,notion,open_ai");
        }
    }
}
