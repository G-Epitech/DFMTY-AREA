...
namespace Zeus.Api.Infrastructure.Migrations
{
    ...
    [Migration("20250119115738_AddGithubsIntegration")]
    partial class AddGithubsIntegration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "IntegrationType", new[] { "discord", "github", "gmail", "league_of_legends", "notion", "open_ai" });
            ...
            modelBuilder.Entity("Zeus.Common.Domain.Integrations.IntegrationAggregate.GithubIntegration", b =>
                {
                    b.HasBaseType("Zeus.Common.Domain.Integrations.IntegrationAggregate.Integration");

                    b.HasDiscriminator().HasValue(IntegrationType.Github);
                });
